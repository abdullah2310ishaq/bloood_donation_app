  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <SectionTitle title="Indel is based on state of the art Features" className="mb-16" />

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Globe Logo (Main Section Image) */}
          <div className="flex justify-center">
            <div className="w-full h-auto rounded-xl overflow-hidden shadow-lg transform transition-all hover:scale-[1.02] duration-300">
              <img
